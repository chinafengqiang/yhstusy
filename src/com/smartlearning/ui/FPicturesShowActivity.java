...
import com.feng.adapter.MyBaseAdapter;
...
public class FPicturesShowActivity extends Activity {
	Gallery gly;
	TextView picture_tv;
	...
	private void init() {
		...
		for (int i = 0; i < selectPictures.size(); i++) {
			...
			String bmpUrl = FScaleImageFromSdcardActivity.map.get(selectPictures
					.get(i));
		...
		adapter = new MyBaseAdapter(FPicturesShowActivity.this, bitmaps);
	...
	public void btnClick(View v){
		...
		case R.id.show_image_btn_back:
			FPicturesShowActivity.this.finish();
