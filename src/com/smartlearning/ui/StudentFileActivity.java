 ...
 */
public class StudentFileActivity extends ActivityGroup {
...
//
	public void changeTab2(View view) {
		Intent i = new Intent(this, myFavortActivity.class);
		View v = getLocalActivityManager().startActivity(StudentFileActivity.class.getName(), i).getDecorView();
		tabcontent.removeAllViews();
		tabcontent.addView(v);
	}
