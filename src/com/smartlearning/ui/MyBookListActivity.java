...
public class MyBookListActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		/* 初始化mPath，用以显示目前路径 */
		rootPath = Environment.getExternalStorageDirectory().getPath() + "/myBook";
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						case 0:
							...
							if (file.isDirectory()) {
								...
								if (t.equals("video")) {
									intentForward("/sdcard/myBook/"+getMIMETypeName(file));
								}
							}
							Tool.ShowMessage(MyBookListActivity.this, is[which]);
							break;
						case 1:
