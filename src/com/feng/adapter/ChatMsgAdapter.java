...
import com.feng.util.FaceConversionUtil;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			if (isComMsg) {
				...
				img.setImageBitmap(BitmapFactory.decodeResource(res,R.drawable.comment));
	...
	public Bitmap getIcon(String uid){
		...
		if(null!=m){
			if(null==m.getThumb()){//设置为默认的
				bmp=BitmapFactory.decodeResource(res,R.drawable.comment);
